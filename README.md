...
| Baskets in a tank | Baskets in a tank, one removed to show the pores |
|---|---|
| ![Baskets in the tank](images/IMG_7615.png) | ![Baskets in the tank, one removed to show the pores](images/IMG_7616.png) |
...
- Baskets should be numbered to reduce/remove the need for us to write on the baskets. We can then record clutch numbers and connect those numbers to the corresponding baskets.
